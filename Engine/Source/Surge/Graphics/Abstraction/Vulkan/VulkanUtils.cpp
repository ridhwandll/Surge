...
namespace Surge
{
    ...
    VkImageUsageFlags VulkanUtils::GetImageUsageFlags(ImageUsage usage, ImageFormat format)
    {
        ...
        case ImageUsage::Texture:
            vkImageUsage |= VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT;
            break;
        case ImageUsage::Storage:
            vkImageUsage |= VK_IMAGE_USAGE_STORAGE_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT;
            break;
        case ImageUsage::None:
            SG_ASSERT_INTERNAL("ImageUsage::None is invalid!");
            break;
        }
    ...
    void VulkanUtils::InsertImageMemoryBarrier(
    ...
    bool VulkanUtils::IsDepthFormat(ImageFormat imageFormat)
    {
        ...
        case ImageFormat::None:
            SG_ASSERT_INTERNAL("ImageFormat::None is invalid in this case!");
            break;
        }
